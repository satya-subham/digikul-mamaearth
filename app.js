...
let images = [
  ...
  {
    img: "https://images.ctfassets.net/66mrrren2unf/7E0O8BZOwrpUgHjNopkk5E/6b7864545a56dcdd5660c06824bd1419/Artboard_1.jpg?q=40",
    id: 5,
  },
  {
    img: "https://images.ctfassets.net/66mrrren2unf/6QikSWMwBOhrxanSgvFCjl/f0ea2ebd469ab3aa0cf2a5ea3fc30ef8/Desktop.jpg?q=40",
    id: 6,
  },
];
    ...
    .then((data) => {
      data.bestsellers.map((item) => {
        mainContainer.innerHTML += `<div class="item-container">
            ...
            <img src=${item.images[0]} alt="" id="home_img_${
          item.id
            ...
            <p class="para"><i class="fa-solid fa-star rate"></i>${
              ...
              <button id="cart_${
                item.id
              }" class="add-to-cart-btn" onclick="add_to_cart(event)">Add to cart</button>
